...
layer = os.path.join('Photos', 'Template', "layer.png")
...
def show_image(image_path , duration):
    ...
    f_layer = pygame.transform.scale(pygame.image.load(layer), (width,height))
    img = pygame.transform.scale(img, (width,height))
    screen.blit(img,(0,0))
    screen.blit(f_layer,(0,0))
...
def takePicture():
    ...
    camera.stop_preview()
    imageCount +=1
    show_image(filename , 6) #show the image for 6s
